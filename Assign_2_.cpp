...
void menu_dda(int a) 
{
	...
	{
	case 1:
		DDA_simple(10, 50, 80, 100);
		break;
	case 2:
		DDA_dashed(-10, 50, -80, 100);
		break;
	case 3:
		DDA_dotted(-10, -50, -80, -100);
		break;
	case 4:
		DDA_solid(10, -50, 80, -100);
		break;
	}
...
void menu_bh(int a) 
{
	...
	{
	case 1:
		BH_simple(10, 50, 80, 100);
		break;
	case 2:
		BH_dashed(-10, 50, -80, 100);
		break;
	case 3:
		BH_dotted(-10, -50, -80, -100);
		break;
	case 4:
		BH_solid(10, -50, 80, -100);
		break;
	}
